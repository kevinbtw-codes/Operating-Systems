...
class SRTLearn extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<SRTLearn> {
  @override
                  ...
                  background: Container(
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('images/SRTF.gif'),
                            fit: BoxFit.cover)),
                    child: Container(
                      decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        FadeAnimation(
                            1.6,
                            Text(
                              "It is the preemptive version of SJF scheduling. In SRTF, the execution of the process can be stopped after certain amount of time.",
