...
class GraphPage2 extends StatefulWidget {
  ...
  GraphPage2({Key key, this.child}) : super(key: key);
...
class _graphpageState extends State<GraphPage2> {
  ...
  generatedata() {
    var BeladyData = [
      new Belady(2, lrualgo(pages_arr, pages_arr.length, 2)),
      new Belady(3, lrualgo(pages_arr, pages_arr.length, 3)),
      new Belady(4, lrualgo(pages_arr, pages_arr.length, 4)),
      new Belady(5, lrualgo(pages_arr, pages_arr.length, 5)),
    ];

    var BeladyData1 = [
      new Belady1('2', lrualgo(pages_arr, pages_arr.length, 2)),
      new Belady1('3', lrualgo(pages_arr, pages_arr.length, 3)),
      new Belady1('4', lrualgo(pages_arr, pages_arr.length, 4)),
      new Belady1('5', lrualgo(pages_arr, pages_arr.length, 5)),
    ];
