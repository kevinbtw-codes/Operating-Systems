...
class GraphPage3 extends StatefulWidget {
  final Widget child;

  GraphPage3({Key key, this.child}) : super(key: key);

  _graphpageState createState() => _graphpageState();
}

class _graphpageState extends State<GraphPage3> {
  List <charts.Series<Belady, int>> beladysData;
  List <charts.Series<Belady1, String>> _seriesData;

  generatedata() {
    var BeladyData = [
      new Belady(2, optimalalgo(pages_arr, pages_arr.length, 2)),
      new Belady(3, optimalalgo(pages_arr, pages_arr.length, 3)),
      new Belady(4, optimalalgo(pages_arr, pages_arr.length, 4)),
      new Belady(5, optimalalgo(pages_arr, pages_arr.length, 5)),
    ];

    var BeladyData1 = [
      new Belady1('2', optimalalgo(pages_arr, pages_arr.length, 2)),
      new Belady1('3', optimalalgo(pages_arr, pages_arr.length, 3)),
      new Belady1('4', optimalalgo(pages_arr, pages_arr.length, 4)),
      new Belady1('5', optimalalgo(pages_arr, pages_arr.length, 5)),
    ];
